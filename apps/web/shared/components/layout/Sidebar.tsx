...
import { ChevronLeft, LayoutDashboard, LogOut, Users, Building2, Map, Contact } from "lucide-react";
...
const NAV_LINKS = [
  ...
  { href: ROUTES.map, labelKey: "sidebar.map", icon: Map },
  { href: ROUTES.leads, labelKey: "sidebar.leads", icon: Contact },
